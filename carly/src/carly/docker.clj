...
(defn setup-ssh!
  ...
  (core/shell! :docker :exec container :ssh-keygen :-f "/etc/ssh/ssh_host_rsa_key" :-N "" :-t :rsa)
  (core/shell! :docker :exec container :ssh-keygen :-f "/etc/ssh/ssh_host_dsa_key" :-N "" :-t :dsa)
  (core/shell! :docker :exec container "/sbin/sshd"))
